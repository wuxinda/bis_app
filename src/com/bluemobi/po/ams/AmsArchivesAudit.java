...
/**
 * 【档案申请审批表】持久化对象 数据库表：ams_archives_audit
 * 
 * @author Riven
 * @date 2016-11
 * 
 */
public class AmsArchivesAudit extends AbstractObject {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AmsArchivesAudit) {
            AmsArchivesAudit amsArchivesAudit = (AmsArchivesAudit) obj;
            if (this.getAuditId().equals(amsArchivesAudit.getAuditId())) {
                return true;
            }
        }
        return false;
