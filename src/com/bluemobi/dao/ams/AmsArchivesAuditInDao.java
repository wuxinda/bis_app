 ...
 * 
 */
public interface AmsArchivesAuditInDao extends MyBatisBaseDao {
    /**
     * 根据用户分组获取审核列表
     * 
     ...
     * @return
     */
    public <T> List<T> getAuditInUserGroupList(Map<String, Object> parmMap);
     ...
     * @param handType
     */
    public void handAmsArchivesAuditIn(Map<String, Object> parmMap);

    /**
     * 批量添加申请事项
     */
    public void addAmsArchivesAuditIns(Map<String, Object> parmMap);
     ...
     * @return
     */
    Integer selectAuditInStatusCount(Map<String, Object> map);
     ...
     * @return
     */
    List<Map<String, Object>> selectAuditInAmsList(Map<String, Object> map);
     ...
     * @return
     */
    List<Map<String, Object>> selectAmsIdByAuditInId(Map<String, Object> map);
     ...
     * @return
     */
    public List<Map<String, String>> getArchivesAuditInList(Map<String, Object> parmMap);
    /**
     * 获取取档还档列表
     * 
     * @param parmMap
     * @return
     */
    public int getAmsArchivesAuditInCountToday();
    /**
     * 获取最新更改数据
     * 
     * @param parmMap
     ...
     * @return
     */
    public List<Map<String, Object>> getAmsArchivesAuditIn(Map<String, Object> parmMap);
    /**
     * 获取取档还档列表
     * 
     * @param parmMap
     * @return
     */
    public List<Map<String, Object>> auditInSubmitList(Map<String, Object> parmMap);
    /**
     * 获取取档还档列表
     * 
     * @param parmMap
     * @return
     */
    public int getAmsArchivesAuditInCount(Map<String, Object> parmMap);
    /**
     * 获取取档还档列表
     * 
     * @param parmMap
     * @return
     */
    public AmsArchivesAuditIn selectObjectByApplyNo(Map<String,Object> map);
}
