...
;(function($){
	...
	/*---------------------------------------------------------------------*/	
		...
		if($(".energy").length>0){
			 ...
			 $("#jcDateMax").hide(); $("#jcDayCon").hide(); 
             $("#jcDateBtn samp").text("本月");
...
/*===========================判断能耗页面默认是月份===========================================*/			
$("article .temp .temp_rt p:eq(0)").click(function(){ 
                           $("#jcDateMax").show(); 
						   $("#jcDayCon").show(); 
                           $("#jcDateBtn samp").text("今天"); })	
						   		
/*------------------------------温湿度页面 点击第一个显示日-------------------------------------*/			
			
$("article .energy nav a:eq(0),article .temp .temp_rt p:eq(1)").click(function(){ 
                           $("#jcDateMax").hide(); 
						   $("#jcDayCon").hide(); 
                           $("#jcDateBtn samp").text("本月");
	...
	/*===========================能耗页面 点击第一个是月份 以及温湿度页面点击第二个是月份===========================================*/	
 
 
 
 
 $(" .energy aside:eq(1) .jcDate").click(function(){ 
													$("#jcDateMax").hide(); 
                                                    $("#jcDayCon").hide(); 
                                                    $("#jcDateBtn samp").text("本年");
													$("#d_next").hide();
													$("#d_prev").hide();
													$("#jcDateTt samp").hide();
													$("#jcDateTt b:eq(1)").hide();
													
													});
													
													/*输入框点击时默认清掉不需要的*/
 $("article .energy nav a:eq(1),article .temp .temp_rt p:eq(2)").click(function(){ $("#jcDateMax").hide(); 
                                                    $("#jcDayCon").hide(); 
                                                    $("#jcDateBtn samp").text("本年");
													$("#d_next").hide();
													$("#d_prev").hide();
