    ...
    <aside>
        <section class="vbox">
            <header class="header bg-white b-b clearfix bmViewHeader">
                ...
                <form action="${BASE_URL}/amsArchivesAudit/page" id="searchForm">
                    <div class="col-sm-12 m-b-xs form-inline text-left p-left-2s">
                        <div class="btn-group">
                            <button type="button" class="btn btn-sm btn-default action-refresh" title="刷新"><i class="fa fa-refresh"></i></button>                           
                        </div>
                        <a href="${BASE_URL}/amsArchivesAudit/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
							...
							<div class="col-sm-4 m-b-xs">
								<div class="bm-nowrap">	
									操作类型： <select name="type" id="type"
										...
										<option value="0">入库申请（存档）</option>
										<option value="1">出库申请 （取档）</option>
...
<script src="${STATIC_URL}/modules/ams/js/archivesAudit.index.js" type="text/javascript"></script>