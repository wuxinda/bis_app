  ...
  <!--左边导航栏-->
	<div class="leftsidebar">
		<ul>
			...
			<li onclick="change(this);" id="select_left"><a href="${BASE_URL}/webJump/pendingList">外部任务列表</a></li>
...
<script src="${STATIC_URL}/modules/web/js/ywcz_pending.js" type="text/javascript"></script>
<script id="archive-data-list-tmpl" type="text/html">
    		 	...
    		 	<!--[for(i=0;i<10;i++){ ]-->
					...
					<!--[}]-->
	   	            ...
	   	            <!--[if(list[i].status==0){]-->
	   	               	 <td><span onclick="jdqr(<!--[=list[i].archivesId]-->,<!--[=list[i].auditId]-->,1,<!--[=list[i].strore_id]-->,<!--[=list[i].strore_area_id]-->,<!--[=list[i].store_column]-->,'<!--[=list[i].store_lr]-->')"><img src="${STATIC_URL}/images/4.2/ams/icon_select.png"/></span>&nbsp;&nbsp;&nbsp;&nbsp;<span onclick="jdsc(<!--[=list[i].archivesId]-->,<!--[=list[i].auditInId]-->,0)"><img src="${STATIC_URL}/images/4.2/ams/icon_close.png"/></span></td>
					<!--[}else if(list[i].status==1){]-->
 						 <td><span onclick="jdsc(<!--[=list[i].archivesId]-->,<!--[=list[i].auditId]-->,2)"><img src="${STATIC_URL}/images/4.2/ams/icon_select.png"/></span></td>
					<!--[}else if(list[i].status==2){]-->
						  <td><span onclick="jdmnrfid(<!--[=list[i].archivesId]-->,<!--[=list[i].auditId]-->,3)"><img src="${STATIC_URL}/images/4.2/ams/icon_select.png"/></span></td>
					<!--[}else{]-->
						  <td></td>
					<!--[}]-->
	   	          	  </tr>
