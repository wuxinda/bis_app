  ...
  <!--左边导航栏-->
	...
	<!--左边导航栏-->
		...
		<div class="datamain_hd">
			<h2 class="datatitle">
			    <span  id="datatitle_left">还档操作</span>
			</h2>
			<!--内容-->
	    ...
	    <div class="sideright">
			<div class="datatitle"  id="datatitle_right">
				...
				<!--表格-->
				<form>
			      		<input type="button" value="申请还档" class="timing_btn">
			      	</form>
	    </div>
	    <!--右边已选档案等-->
...
<script src="${STATIC_URL}/modules/web/js/ams_cdsq4.js" type="text/javascript"></script>
</html>