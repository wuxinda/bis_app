            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/ecsManage/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form action="${BASE_URL}/ecsManage/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/ecs/js/manage.index.js" type="text/javascript"></script>