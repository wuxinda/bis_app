            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/adminToken/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form action="${BASE_URL}/adminToken/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/admin/js/token.index.js" type="text/javascript"></script>