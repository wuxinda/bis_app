            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/adminRole/add?userType=0" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加后台角色</a>
                    </div>
                    <form action="${BASE_URL}/adminRole/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/admin/js/role.index.js" type="text/javascript"></script>