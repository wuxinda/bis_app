            ...
            <header class="header bg-white b-b clearfix bmViewHeader">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/systemHotSearch/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/systemHotSearch/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/system/js/hotSearch.index.js" type="text/javascript"></script>