            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/rfidInout/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form action="${BASE_URL}/rfidInout/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/rfid/js/inout.index.js" type="text/javascript"></script>